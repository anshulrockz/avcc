...
<tbody>
	...
	<tr>
		...
		<td>Coupus Fund</td>
		<td>00440035</td>
		<td>{{$total = $total + slash_decimal($receipt[0]->corpus_fund)}}</td>
		<td>-</td>
		<td>-</td>
		<td>-</td>
		<td>-</td>
	...
	<tr>
		...
		<td>00440035</td>
		<td>{{$total = $total + slash_decimal($receipt[0]->security)}}</td>
		<td>-</td>
		<td>-</td>
		<td>-</td>
		<td>-</td>
    ...
    <tr>
        ...
        <td>{{round($receipt[0]->corpus_fund)}}</td>
	</tr>
	<tr>
        <td style="border-top: none;border-right: none" colspan="8" class="right-align">CGST:</td>
        <td style="border-top: none;">{{round(percent_amount($cgst,$receipt[0]->corpus_fund))}}</td>
	</tr>
	<tr>
        <td style="border-top: none;border-right: none" colspan="8" class="right-align">SGST:</td>
        <td style="border-top: none;">{{round(percent_amount($sgst,$receipt[0]->corpus_fund))}}</td>
	</tr>
	<!--<tr>
	...
	<tr>
        ...
        <td style="border-top: none;">
        	@if($receipt[0]->reverse_charges == '1')
        		{{round(percent_amount($cgst+$sgst,$receipt[0]->corpus_fund))}}
        	@else
        		0
        	@endif
        </td>
	...
	<tr>
        ...
        <td style="border-top: none;"> {{round($receipt[0]->corpus_fund + percent_amount($cgst+$sgst,$receipt[0]->corpus_fund))}}
        </td>
	</tr>
</tbody>
</table>

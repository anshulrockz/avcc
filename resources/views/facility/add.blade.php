...
<div id="page-wrapper">       
    <div class="row">
		...
		<form method="post" action="{{ url('facility/save') }}" id="valWizard" class="panel-wizard">
		{{ csrf_field() }}
            ...
            <div class="tab-content">
                <div class="tab-pane" id="tab1-4">
					...
					<div class="form-group">
					    ...
					    <input type="number" class="form-control" placeholder="Enter SAC Code" name="sac_code" id="sac_code">
					</div>
					<div class="form-group">
					<label>Tax:</label>
					  <div class="form-group">
                ...
                <div class="tab-pane" id="tab2-4">
					...
					<div class="form-group" style="display: none">
					    <label>SGST(%):</label>
					    <input type="number" class="form-control" placeholder="Enter SGST" name="rebate_vat" id="rebate_vat" step="0.01">
					</div>
                </div>

...
<div id="page-wrapper">       
    <div class="row">
		...
		@endif
		<form method="post" action="{{ url('receipt-fd/save') }}">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
					    <label>*Bank Name:</label>
					    <input type="text" class="form-control" placeholder="Enter bank name" name="party_name" id="party_name" required="">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
					    <label>Bank GSTIN:</label>
					    <input type="text" class="form-control" placeholder="Enter bank GSTIN" name="party_gstin" id="party_gstin">
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
					    ...
					    <input type="number" class="form-control" placeholder="Enter amount" name="fd_principal_amt" id="fd_principal_amt" required="">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
					    ...
					    <input type="number" class="form-control" placeholder="Enter amount" name="fd_interest" id="fd_interest">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">

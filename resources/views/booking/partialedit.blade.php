...
<div id="page-wrapper">       
    <div class="row">
		...
		<form method="post" action="{{ url('booking/partialupdate/'.$booking[0]->id) }}" id="valWizard" class="panel-wizard">
		{{ csrf_field() }}
            ...
            <div class="tab-content">
                <div class="tab-pane" id="tab1-4">
					<div class="form-group">
					    ...
					    <input type="number" class="form-control" name="booking_id" id="booking_id" value="{{ $booking[0]->id }}" disabled="">
					</div>
					<div class="form-group">
					    <label>Booking Form No:</label>
					    <input type="number" class="form-control" placeholder="Enter booking number" name="booking_no" id="booking_no" value="{{ $booking[0]->booking_no }}">
					</div>
					<div class="form-group">
					    <label>Booking Date:</label>
					    <div class="input-group date">
						  <input type="text" name="booking_date" id="booking_date" value="{{ date_dfy($booking[0]->booking_date) }}" class="form-control" placeholder="Enter booking date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					    </div>
					</div>
				    <div class="row">
						<div class="col-sm-6">
							<div class="form-group">
							  ...
							  <div class="input-group noerror">
								<input type="number" class="form-control" placeholder="Enter membership number" name="membership_no" id="membership_no" value="{{$booking[0]->membership_no}}" required=""><span class="input-group-addon search"><i class="fa fa-search"></i></span>
							  </div>
						    </div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
							    <div style="margin-top: 32px">
                                    <input type="checkbox" name="sponsor" id="sponsor" value="1" <?php if($booking[0]->is_sponsor == '1'){echo "checked" ;} ?> onchange="checkSponsor();">
				    ...
				    <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="member_name" value="{{$booking[0]->member_name}}" disabled="">
					</div>
					<div class="form-group">
					    <label>Member Type:</label>
					    <input type="text" class="form-control" id="member_type" value="{{$booking[0]->member_type}}" disabled="">
					    <input type="hidden" class="form-control" id="membertype_id" value="{{$booking[0]->membertype_id}}">
					</div>
					<div class="form-group">
					    <label>Phone:</label>
					    <input type="number" class="form-control" placeholder="Enter phone" name="phone" id="phone" value="{{ $booking[0]->phone }}">
					</div>
					<div class="form-group">
					    <label>Mobile:</label>
					    <input type="number" class="form-control" placeholder="Enter mobile" name="mobile" id="mobile" value="{{ $booking[0]->mobile }}">
					</div>
					<div class="form-group">
					  <label>Address:</label>
					  <textarea rows="4" class="form-control" placeholder="Enter address" name="address" id="address" maxlength="400">{{ $booking[0]->address }}</textarea>
					</div>
					<div class="form-group">
					    <label>Bill Number:</label>
					    <input type="number" class="form-control" placeholder="Enter bill number" name="bill_no" id="bill_no" value="{{ $booking[0]->bill_no }}">
					</div>
					<div class="form-group">
					    <label>Bill Date:</label>
					    <div class="input-group date">
						  <input type="text" name="bill_date" id="bill_date" value="{{ date_dfy($booking[0]->bill_date) }}" class="form-control" placeholder="Enter bill date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					    </div>
					</div>
					<div class="form-group">
					    <label>*Party Name:</label>
					    <input type="text" class="form-control" placeholder="Enter party name" name="party_name" id="party_name" value="{{ $booking[0]->party_name }}" required="">
					</div>
					<div class="form-group">
					    <label>Party GSTIN:</label>
					    <input type="text" class="form-control" placeholder="Enter party GSTIN" name="party_gstin" id="party_gstin" value="{{ $booking[0]->party_gstin }}">
					</div>
					<div class="form-group">
					    <label>*Reverse Charges:</label>
					    <select class="form-control" name="reverse_charges" id="reverse_charges" required="">
					    	<option value="1" @if($booking[0]->reverse_charges == '1') selected @endif>Yes</option>
					    	<option value="0" @if($booking[0]->reverse_charges == '0') selected @endif>No</option>
					    </select>
					</div>
					<div class="form-group">
					    <label>*Function Date:</label>
					    <div class="input-group date noerror">
						  <input onchange="auto_date();" type="text" name="function_date" id="function_date" value="{{ date_dfy($booking[0]->function_date) }}" class="form-control" placeholder="Enter function date" required=""><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
					    </div>
					</div>
					<div class="form-group" style="display: inline-block; width: 49.6%">
						...
						<div class="input-group clockpicker noerror">
						  <input type="text" class="form-control" name="from_time" id="from_time" value="{{ slash_second($booking[0]->from_time) }}" placeholder="Enter from time" required="">
					...
					<div class="form-group" style="display: inline-block; width:49.6%">
						<label>&nbsp;</label>
						<div class="input-group clockpicker noerror">
						  <input type="text" class="form-control" name="to_time" id="to_time" value="{{ slash_second($booking[0]->to_time) }}" placeholder="Enter to time" required="">
						  <span class="input-group-addon">
						    <span class="glyphicon glyphicon-time"></span>
						  </span>
						</div>
					...
					<div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Enter function type" name="function_type" id="function_type" value="{{ $booking[0]->function_type }}">
					</div>
					<div class="form-group">
					    <label>No of Persons:</label>
					    <input type="number" class="form-control" placeholder="Enter number of persons" name="noofpersons" id="noofpersons" value="{{ $booking[0]->noofpersons }}">
					</div>
                </div><!-- tab-pane -->
				      ...
				      <tbody>
				      	<tr>
				      	  ...
				      	  <td style="min-width: 140px;" class="noerror quantity_block">
				      	  	<input type="number" name="quantity" id="quantity" class="form-control" placeholder="Enter Quantity" max="8" min="1">
				      	  </td>
						  ...
						  <td style="max-width: 200px" class="noerror">
							  <div class="input-group date">
								<input type="text" name="from_date" id="from_date" value="{{ date_dfy($booking[0]->function_date) }}" class="form-control" placeholder="Enter from date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
							  </div>
						  </td>
						  <td style="max-width: 200px" class="noerror">
							  <div class="input-group date">
								<input type="text" name="to_date" id="to_date" value="{{ date_dfy($booking[0]->function_date) }}" class="form-control" placeholder="Enter to date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
							  </div>
						  </td>
					...
					<div class="table-responsive" style="overflow-x: scroll">
						<table class="table table-bordered">
							...
							<tbody class="field_wrapper">
								...
								<tr>
									<td>{{ $value->facility_name }}<input type="hidden" name="facility_id[]" value="{{ $value->facility_id }}"></td>
									<td>{{ $value->quantity }}<input type="hidden" name="quantity[]" value="{{ $value->quantity }}"></td>
									<td>{{ $value->noofdays }}<input type="hidden" name="noofdays[]" value="{{ $value->noofdays }}"></td>
									<td>{{ date_dfy($value->from_date) }}<input type="hidden" name="from_date[]" value="{{ date_ymd($value->from_date) }}"></td>
									<td>{{ date_dfy($value->to_date) }}<input type="hidden" name="to_date[]" value="{{ date_ymd($value->to_date) }}"></td>
									<td>{{ $value->booking_rate }}<input type="hidden" name="booking_rate[]" value="{{ $value->booking_rate }}"></td>
									<td>{{ $value->generator_charges }}<input type="hidden" name="generator_charges[]" value="{{ $value->generator_charges }}"></td>
									<td>{{ $value->ac_charges }}<input type="hidden" name="ac_charges[]" value="{{ $value->ac_charges }}"></td>
									<td>{{ $value->safai_general }}<input type="hidden" name="safai_general[]" value="{{ $value->safai_general }}"></td>
									<td>{{ $value->security_charges }}<input type="hidden" name="security_charges[]" value="{{ $value->security_charges }}"></td>
									<td>{{ $value->rebate_safai }}<input type="hidden" name="rebate_safai[]" value="{{ $value->rebate_safai }}"></td>
									<td>{{ $value->rebate_tentage }}<input type="hidden" name="rebate_tentage[]" value="{{ $value->rebate_tentage }}"></td>
									<td>{{ $value->rebate_catering }}<input type="hidden" name="rebate_catering[]" value="{{ $value->rebate_catering }}"></td>
									<td>{{ $value->rebate_electricity }}<input type="hidden" name="rebate_electricity[]" value="{{ $value->rebate_electricity }}"></td>
									<td>{{ $value->servicetax_percentage }}<input type="hidden" name="servicetaxPercentage[]" value="{{ $value->servicetax_percentage }}"></td>
									<td>{{ $value->servicetax_amount }}<input type="hidden" name="servicetaxAmount[]" value="{{ $value->servicetax_amount }}"></td>
									<td>{{ $value->vat_percentage }}<input type="hidden" name="vatPercentage[]" value="{{ $value->vat_percentage }}"></td>
									<td>{{ $value->vat_amount }}<input type="hidden" name="vatAmount[]" value="{{ $value->vat_amount }}"></td>
									<td>{{ $value->total_amount }}<input type="hidden" name="totalAmount[]" value="{{ $value->total_amount }}"></td>
								</tr>
								@endforeach
								<?php }?>
								<tr class="bottom-area">
									<td colspan="17"><input class="form-control" type="text" name="misc" value="{{$booking[0]->misc}}" placeholder="Misc"></td>
									<td colspan="2" class="noerror"><input class="form-control" type="number" name="misc_amount" value="{{$booking[0]->misc_amount}}" placeholder="Enter amount"></td>
								</tr>
								<tr>
									<td colspan="17"><input class="form-control" type="text" name="others" value="{{$booking[0]->others}}" placeholder="Others"></td>
									<td colspan="2" class="noerror"><input class="form-control" type="number" name="others_amount" value="{{$booking[0]->others_amount}}" placeholder="Enter amount"></td>
								</tr>
							</tbody>
						</table>
					</div>

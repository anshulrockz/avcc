...
<div id="page-wrapper">       
    <div class="row">
		...
		<form method="post" action="{{ url('booking/update/'.$booking[0]->id) }}" id="valWizard" class="panel-wizard">
		{{ csrf_field() }}
						...
						<table class="table table-bordered">
							...
							<tbody class="field_wrapper">
								...
								<tr class="bottom-area">
									<td colspan="18"><input class="form-control" type="text" name="misc" value="{{$booking[0]->misc}}" placeholder="Misc"></td>
								...
								<tr>
									<td colspan="18"><input class="form-control" type="text" name="others" value="{{$booking[0]->others}}" placeholder="Others"></td>

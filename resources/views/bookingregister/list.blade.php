...
<div id="page-wrapper">  
    ...
    <div class="row" style="margin-top: 10px">
		...
		<?php if($count>0){ ?>
		  ...
		  <h4 class="center-underline onlyprint">Booking Register</h4>
		  	@if($_POST && $_POST>0)
			  ...
			  <table class="table table-bordered" style="border: 1px solid #ddd; margin-top: 15px">
			    ...
			    <tbody>
		          ...
		          <tr>
		            ...
		            <td>{{number_format((float)$value->service_tax+$value->others_amount*$global_st/100, 2, '.', '')}}</td>
		            <td>{{number_format((float)$value->vat+$value->others_amount*$global_vat/100, 2, '.', '')}}</td>
		          </tr>
		          <?php $i++; } ?>
			    </tbody>
			  </table>
